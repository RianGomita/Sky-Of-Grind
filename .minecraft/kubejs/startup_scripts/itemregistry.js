...
sog.create('orbital_space_containment_casing')
    ...
    sog.create('interstellar_fusion_module')
        ...
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')
    sog.create('draconic_assembly_control_casing')
        .displayName('Draconic Assembly Control Casing')
        .textureAll('kubejs:block/casings/draconic_assembly_control_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')
    sog.create('draconic_assembly_line_casing')
        .displayName('Draconic Assembly Line Casing')
        .textureAll('kubejs:block/casings/draconic_assembly_line_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')  
    sog.create('draconic_assembly_line_grating')
        .displayName('Draconic Assembly Line Grating')
        .textureAll('kubejs:block/casings/draconic_assembly_line_grating')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')  
    sog.create('draconium_machine_casing')
        .displayName('Draconium Machine Casing')
        .textureAll('kubejs:block/casings/draconium_machine_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')       
    sog.create('eternity_assembly_control_casing')
        .displayName('Eternity Assembly Control Casing')
        .textureAll('kubejs:block/casings/eternity_assembly_control_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        ...
        .tagBlock('forge:mineable/wrench')
       .tagBlock('forge:mineable/wrench')
        sog.create('covalent_conducting_casing')
        .displayName('Covalent-Conducting Casing')
        .textureAll('kubejs:block/casings/covalent_conducting_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')
    sog.create('refracting_hastelloy_c276_casing')
        .displayName('Refracting Hastelloy-C276 Casing')
        .textureAll('kubejs:block/casings/refracting_hastelloy_c276_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')
    sog.create('reinforced_base_casing')
        .displayName('Reinforced Base Casing')
        .textureAll('kubejs:block/casings/reinforced_base_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        .lightLevel(0)
        .tagBlock('forge:mineable/wrench')
    sog.create('supercritical_cryo_cooled_casing')
        .displayName('Supercritical Cryo-Cooled Casing')
        .textureAll('kubejs:block/casings/supercritical_cryo_cooled_casing')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
