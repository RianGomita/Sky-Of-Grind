...
StartupEvents.registry('item', sog => {
    ...
    sog.create('emitter_red').maxStackSize(64).displayName('§4Laser Emmiter(Red)').glow(true)
    sog.create('emitter_blue').maxStackSize(64).displayName('§4Laser Emmiter(Red)').glow(true)
    sog.create('emitter_green').maxStackSize(64).displayName('§4Laser Emmiter(Red)').glow(true)
    sog.create('laser_containment_cell_red').maxStackSize(64).displayName('§4Laser Containment Cell(Red)').glow(true)
    sog.create('laser_containment_cell_blue').maxStackSize(64).displayName('§1Laser Containment Cell(Blue)').glow(true)
    sog.create('laser_containment_cell_green').maxStackSize(64).displayName('§aLaser Containment Cell(Green)').glow(true)
