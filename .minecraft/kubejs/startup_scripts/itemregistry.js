...
// F U S I O N   M K 4
    ...
    sog.create('adv_high_power_crushing_wheels')
        ...
        .defaultCutout()
        .tagBlock('forge:mineable/wrench')
    sog.create('fusion_casing_mk5')
        .displayName('Fusion Machine Casing MK V')
        .textureAll('kubejs:block/casings/fusion_casing_mk5')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
        ...
        .defaultCutout()
        .tagBlock('forge:mineable/wrench')
    sog.create('fusion_coil_mk3')
        .displayName('Fusion Coil Block MK III')
        .textureAll('kubejs:block/casings/fusion_coil_mk3')
        .soundType('metal')
        .resistance(1)
        .requiresTool(true)
        .hardness(9)
