GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('hyper_bender', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle("BAAACCCCCCCB", "CDDDCDDDDDDC", "CEEECFFFFFFC", "CDDDCDDDDDDC", "BGGGBCCCCCCB")
            .aisle("BACCCCCCCCCB", "CDDDCDDDDDDC", "CEEECFFFFFFC", "CDDDCDDDDDDC", "BGGGBCCCCCCB")
            .aisle("BAACCCCCCCCB", "CDDDCDDDDDDC", "CEEECFHHHHFC", "CDDDCDDDDDDC", "BGGGBCCCCCCB")
            .aisle("BBBBBBBBBBBB", "BCICBCCCCCCB", "BCCCBCGGGGCB", "BCCCBCCCCCCB", "BBBBBBBBBBBB")
