ServerEvents.recipes(event => {
    ...
    var component_circuits   = [19, 20, 21];
    // Duration increase
    ...
    var baseRecipes = [
        // Robot Arms
        {
            recipeIdPrefix: 'lv_sensor',
            outputItem: 'gtceu:lv_sensor',
            items: [
                ['#gtceu:circuits/lv', 1],
        ...
        {
            recipeIdPrefix: 'mv_sensor',
            outputItem: 'gtceu:mv_sensor',
            items: [
                ['#gtceu:circuits/mv', 1],
        ...
        {
            recipeIdPrefix: 'hv_sensor',
            outputItem: 'gtceu:hv_sensor',
            items: [
                ['#gtceu:circuits/hv', 1],
            ...
            fluids: [
                ['gtceu:chromium', 72],
                ['gtceu:stainless_steel', 576]
            ],
            duration: 2250,
            EUt: GTValues.VA[GTValues.UV]
        },
        {
            recipeIdPrefix: 'ev_sensor',
            outputItem: 'gtceu:ev_sensor',
            items: [
                ['#gtceu:circuits/ev', 1],
                ['gtceu:quantum_eye', 1]
            ],
        ...
        {
            recipeIdPrefix: 'iv_sensor',
            outputItem: 'gtceu:iv_sensor',
            items: [
                ['#gtceu:circuits/iv', 1],
        ...
        {
            recipeIdPrefix: 'luv_sensor',
            outputItem: 'gtceu:luv_sensor',
            items: [
        ...
        {
            recipeIdPrefix: 'zpm_sensor',
            outputItem: 'gtceu:zpm_sensor',
            items: [
        ...
        {
            recipeIdPrefix: 'uv_sensor',
            outputItem: 'gtceu:uv_sensor',
            items: [
        ...
        {
            recipeIdPrefix: 'uhv_sensor',
            outputItem: 'gtceu:uhv_sensor',
            items: [
        ...
        {
            recipeIdPrefix: 'uev_sensor',
            outputItem: 'gtceu:uev_sensor',
            items: [
        ...
        {
            recipeIdPrefix: 'uiv_sensor',
            outputItem: 'gtceu:uiv_sensor',
            items: [
        ...
        {
            recipeIdPrefix: 'uxv_sensor',
            outputItem: 'gtceu:uxv_sensor',
            items: [
