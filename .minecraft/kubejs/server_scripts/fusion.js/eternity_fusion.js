ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.eternity_fusion('eternity_fusion_34')
        ...
        // ONLY ETERNITY FUSION PLASMAS

        event.recipes.gtceu.eternity_fusion('neutron_flux')
        .inputFluids('gtceu:neon_plasma_plasma 144', 'gtceu:cryogenic_neutron_flow 1600')
        .outputFluids('gtceu:neutron_flux_plasma 3040')
        .duration(30)
        .EUt((GTValues.VA[GTValues.UEV]))
            event.recipes.gtceu.eternity_fusion('tungsten')
        .inputFluids('gtceu:neutron_flux_plasma 3040', 'gtceu:tungsten 16')
        .outputFluids('gtceu:tungsten_plasma_plasma 3040')
        .duration(30)
        .EUt((GTValues.VA[GTValues.UEV]))
            event.recipes.gtceu.eternity_fusion('plutonium239')
        .inputFluids('gtceu:tungsten_plasma_plasma 3040', 'gtceu:plutonium 16')
        .outputFluids('gtceu:plutonium_239_plasma_plasma 3040')
        .duration(30)
        .EUt((GTValues.VA[GTValues.UEV]))
            event.recipes.gtceu.eternity_fusion('decay_stabilized')
        .inputFluids('gtceu:osmium_plasma_plasma 3040', 'gtceu:exotic_particle_suspension 16')
        .outputFluids('gtceu:decay_stabilized_plasma 3040')
        .duration(30)
        .EUt((GTValues.VA[GTValues.UEV]))
            event.recipes.gtceu.eternity_fusion('iridium')
        .inputFluids('gtceu:plutonium_239_plasma_plasma 3040', 'gtceu:iridium 16')
        .outputFluids('gtceu:iridium_plasma_plasma 3040')
        .duration(30)
        .EUt((GTValues.VA[GTValues.UEV]))
            event.recipes.gtceu.eternity_fusion('osmium')
        .inputFluids('gtceu:iridium_plasma_plasma 3040', 'gtceu:osmium 16')
        .outputFluids('gtceu:osmium_plasma_plasma 3040')
        .duration(30)
        .EUt((GTValues.VA[GTValues.UEV]))
});